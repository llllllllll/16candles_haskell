...
resolveReg R0_f                 = 0x14
resolveReg R0_b                 = 0x15
resolveReg R1_f                 = 0x16
resolveReg R1_b                 = 0x17
resolveReg R2_f                 = 0x18
resolveReg R2_b                 = 0x19
resolveReg R3_f                 = 0x1a
resolveReg R3_b                 = 0x1b
resolveReg R4_f                 = 0x1c
resolveReg R4_b                 = 0x1d
resolveReg R5_f                 = 0x1e
resolveReg R5_b                 = 0x1f
resolveReg R6_f                 = 0x20
resolveReg R6_b                 = 0x21
resolveReg R7_f                 = 0x22
resolveReg R7_b                 = 0x23
resolveReg R8_f                 = 0x24
resolveReg R8_b                 = 0x25
resolveReg R9_f                 = 0x26
resolveReg R9_b                 = 0x27
